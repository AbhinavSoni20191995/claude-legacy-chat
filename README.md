...
Fork this repo or push your own copy to GitHub
Create a new project on Railway → Deploy from GitHub
Set environment variable: PRODUCTION_DOMAIN = your Railway URL (locks CORS)
Optional: NOTIFY_WEBHOOK_URL = webhook URL to receive waitlist/help signal notifications
Self-hosting
...
Bump the version string in public/sw.js line 3: const APP_VERSION = 'v6.3'; -> 'v6.4'
Commit and push
Users with the app installed see a banner: "New version available - Refresh"
Tap -> app reloads with latest version
